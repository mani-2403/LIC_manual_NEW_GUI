...
class XorGateGUI(QWidget):
    def __init__(self):
        super().__init__()
        self.setWindowTitle("IC 7486 XOR Gate GUI")
        ...
        self.images = {
            ...
            "ic_7486": QPixmap(r"C:\Users\bhuvaneshwari\OneDrive\Pictures\Screenshots\component\EXOR_gate.jpeg"),
        ...
        self.place_image("ic_7486", 500, 200, 300, 300)
    ...
    def paintEvent(self, event):
        ...
        # Connection lines same as previous gates
