...
class NorGateGUI(QWidget):
    def __init__(self):
        super().__init__()
        self.setWindowTitle("IC 7402 NOR Gate GUI")
        ...
        self.images = {
            ...
            "ic_7402": QPixmap(r"C:\Users\bhuvaneshwari\OneDrive\Pictures\Screenshots\component\NOR_gate.jpeg"),
        ...
        self.place_image("ic_7402", 500, 200, 300, 300)
    ...
    def update_images(self):
        for name, label in self.labels.items():
            ...
            if name.startswith("switch"):
                ...
                # NOR logic: Output is ON only if both inputs are OFF
                output = not (a or b)
    ...
    def paintEvent(self, event):
        ...
        # Full connection lines (same as AND/NAND)
