...
class OrGateGUI(QWidget):
    def __init__(self):
        super().__init__()
        self.setWindowTitle("IC 7432 OR Gate GUI")
        ...
        self.images = {
            ...
            "ic_7408": QPixmap(r"C:\Users\bhuvaneshwari\OneDrive\Pictures\Screenshots\component\and_gate.jpeg"),  # Replace with OR image if available
    ...
    def update_images(self):
        for name, label in self.labels.items():
            ...
            if name.startswith("switch"):
                ...
                out = a or b
                pixmap = self.images["led_on"] if out else self.images["led_off"]
            else:
